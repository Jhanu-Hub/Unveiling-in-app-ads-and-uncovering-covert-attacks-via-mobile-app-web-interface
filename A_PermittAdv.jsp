...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style1">Uneilling in app ads and uncovering covert attacks via mobile app-web interface</a></h1>
      </div>
      <div class="menu_nav">
        <ul>
      ...
      <div class="mainbar">
		...
		String dt1 = strDate + "   " + strTime;
					...
					if ( rs2.next() )
					 ...
					 int uamount=Integer.parseInt(rs2.getString(1));	
							...
							//String ip1 = request.getRemoteAddr();
                                                        String ip1=localHost.getHostAddress();
				...
				ResultSet rs3=st3.executeQuery(query3);
					if ( rs3.next() )
					{%>
                  <h3 class="style5 style4"><%=uname%> is Malicious User By Advertising With InSufficient Balance!!!</h3>
			...
			int i=s.executeUpdate("insert into evidence values('"+type+"','"+uname+"','"+ip1+"','"+dt1+"','"+state1+"','"+blockdate+"','"+uurl+"')");
			
			PreparedStatement ps1=connection.prepareStatement("delete from advrequest where uname='"+uname+"' ");
			ps1.executeUpdate();
			
			%>
                  <h3 class="style5 style4"><%=uname%> Have Become Malicious User By Advertising With InSufficient Balance!!!</h3>
				  <p align="right"><a href="A_UserAdvReq.jsp">Back</a></p>
                    <%
			}
		}	
